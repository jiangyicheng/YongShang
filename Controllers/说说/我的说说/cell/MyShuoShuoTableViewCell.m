...
@interface MyShuoShuoTableViewCell ()
{
    SDWeiXinPhotoContainerView* _photoView;
}
@end

@implementation MyShuoShuoTableViewCell

- (void)awakeFromNib {
    self.dateLab.font = DEF_FontSize_12;
    ...
    .widthIs(getNumWithScanf(280));
    
    self.deleteBtn.sd_layout
    .rightSpaceToView(self.contentView,getNumWithScanf(20))
    .topSpaceToView(self.contentView,getNumWithScanf(20))
    .widthIs(getNumWithScanf(80))
    .heightIs(getNumWithScanf(40));
    
    self.contentLab.sd_layout
    .leftSpaceToView(self.contentView,getNumWithScanf(20))
    .topSpaceToView(self.dateLab,10)
    .rightSpaceToView(self.contentView,getNumWithScanf(20))
    .autoHeightRatio(0);
...
-(void)setModel:(SSAllTalkDetailModel *)model
{
    ...
    NSLog(@"pinglun--%@",model.is_talkmessage);
