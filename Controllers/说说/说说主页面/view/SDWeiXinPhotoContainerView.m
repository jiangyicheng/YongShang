...
- (void)setPicPathStringsArray:(NSArray *)picPathStringsArray
{
    ...
    [_picPathStringsArray enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if (![obj isKindOfClass:[UIImage class]]) {
          [imageView sd_setImageWithURL:[NSURL URLWithString:obj] placeholderImage:[UIImage imageNamed:@"loadFailed"] options:SDWebImageAllowInvalidSSLCertificates];
        }else{
...
//    if (![self.bigPathStringArray[imageView.tag] isKindOfClass:[UIImage class]]) {
...
{
    if (![self.bigPathStringArray[index] isKindOfClass:[UIImage class]]) {
        NSString *imageName = self.bigPathStringArray[index];
