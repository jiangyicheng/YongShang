...
- (instancetype)initWithFrame:(CGRect)frame WithImages:(NSArray *)images
{
	...
	if (self) {
		...
		for (int i=0; i<images.count; i++) {
			UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH*i, 0, SCREEN_WIDTH+1, SCREEN_HEIGHT)];
			...
			if (i == images.count-1) {
				...
				UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH*0.3, SCREEN_HEIGHT*0.86, SCREEN_WIDTH*0.4, 70)];
